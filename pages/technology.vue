      ...
      <div class="tech-content">
        <div class="btn-container">
          <button
            ...
            :key="tab"
            @click="activeTab = tab"
            :class="['btn', activeTab === tab ? 'active' : '']"
          >
            <span class="index">{{ Number(tab) + 1 }}</span>
          </button>
        </div>
...
import capsuleImgMobile from '../assets/technology/image-space-capsule-landscape.jpg'
export default {
  data: () => ({
    tabs: ['0', '1', '2'],
    activeTab: '0',
